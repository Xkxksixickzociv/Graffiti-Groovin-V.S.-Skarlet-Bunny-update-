...
makeLuaSprite('bg', 'bas/bg', -600, -100);
    ...
    scaleObject('bg', 1.0, 1.0) 
     ...
     makeAnimatedLuaSprite('nene', 'bas/nene2', 2700, 1330);
    addAnimationByPrefix('nene', 'nene', 'nene bop', 24, true);  
    ...
    scaleObject('cd', 1.0, 1.0)
       ...
       makeAnimatedLuaSprite('nenexd', 'bas/darnell', 550, 1330);
    addAnimationByPrefix('nenexd', 'nenexd', 'darnell bop', 24, true);  
