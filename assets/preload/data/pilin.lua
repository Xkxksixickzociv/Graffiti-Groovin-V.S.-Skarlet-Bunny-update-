...
;
   ...
   setProperty('9.visible', true);
      ...
      setProperty('1speed.visible', false);
   setProperty('2speed.visible', false);
      setProperty('sprite ...visible', false);
      setProperty('sprite.visible', false);


      setProperty('BG/stardustBG1speed.visible', false);
      setProperty('BG/stardustBG2speed.visible', false);
