...
makeAnimatedLuaSprite('3', 'metro/fps/3', -3850, -770);
    addAnimationByPrefix('3', '3', 'DOORS OPENING', 12, true);  
    objectPlayAnimation('3', '3', true)
    addLuaSprite('3', false);
    scaleObject('3', 1.2, 1.2)  
doTweenX('3', '3', -50, 4.8, 'lineal')
...
if value1 == '6' then
      ...
      makeAnimatedLuaSprite('3', 'metro/fps/3', -50, -770);
    addAnimationByPrefix('3', '3', 'DOORS CLOSING', 20, true);  
    objectPlayAnimation('3', '3', true)
    addLuaSprite('3', false);
    scaleObject('3', 1.2, 1.2)  
doTweenX('3', '3', 3700, 3.5, 'lineal')
