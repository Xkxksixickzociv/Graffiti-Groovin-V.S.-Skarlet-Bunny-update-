...
name_of_character_xml = 'pump' -- Nombre del Xml y sprite
name_of_character = 'pump' -- Nombre que le pondras al personaje
name_of_notetype = 'PumpNote' -- Nombre de su flecha individual
name_of_notetype2 = 'sa' --Nombre de la flecha cantando con Oponente principal
name_of_notetype3 = 'PUto' --Todos cantan
...
foreground = false
--Para usar la funcion de capas , foreground debe estar en false y borrar los dos '--' de abajo y de la linea 112 (o del -- setObjectOrder(name_of_character,Capa); que esta abajo)
Capa = 4
...
idle_xml_name = 'idle'
left_xml_name = 'pump_left'
down_xml_name = 'pump_down'
up_xml_name = 'pump_up'
right_xml_name = 'pump_right'
